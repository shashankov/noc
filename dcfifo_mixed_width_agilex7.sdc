...
# Added to remove recovery violations on the aclr paths
set_false_path -to $hier_path|dcfifo_mixed_widths_component|auto_generated|dffpipe_*:wraclr|dffe*a[0]
set_false_path -to $hier_path|dcfifo_mixed_widths_component|auto_generated|dffpipe_*:rdaclr|dffe*a[0]
