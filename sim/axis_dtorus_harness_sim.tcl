...
#
vlog $QSYS_SIMDIR/../test/axis_dtorus_harness_tb_sim.sv $QSYS_SIMDIR/../src/*.sv $QSYS_SIMDIR/../src/topologies/*.sv $QSYS_SIMDIR/../src/fifos/*.sv $QSYS_SIMDIR/../test/harness/*sv
#
